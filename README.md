...
This module was created for my own use, so it may not be easy for others to work with. Nevertheless, I have created the documentation below both as a reference for myself and so that anyone interested can look through it because it has allowed me to drastically simplify some animations.
